 ...
 */
final class Version20180711152444 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE school_unit ADD schoolyear_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE school_unit DROP schoolyear_id');
    }
}
