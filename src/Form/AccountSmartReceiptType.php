...
class AccountSmartReceiptType extends AbstractType
{
    private $formCount;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('totalPaid', MoneyType::class, array(
              ...
              'scale' => 2,
              'mapped' => false,
              // TODO consider dropping this totalPaid variable alltogether
              // (is currently imported from old system)
              'disabled' => true,
              'attr' => array('class' => 'form-control'),
            ))
        ;
